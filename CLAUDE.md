...
- **The app has two tabs**: RAG (Tab 1) and Massive Context (Tab 2). The Data Explorer tab was removed, and with it the only pandas usage in `app.py`.
